...
func TestClientMiddlewareContext(t *testing.T) {
	...
	ctx := context.New()
	cli.Client.Middleware.Run("request", ctx)
	cli.Client.Middleware.Run("response", ctx)
...
func TestClientPath(t *testing.T) {
	...
	cli.Path(path)
	cli.Client.Middleware.Run("request", cli.Client.Context)
	st.Expect(t, cli.Client.Context.Request.URL.String(), "http://foo.com/foo/baz")
}
...
func TestClientPathParam(t *testing.T) {
	...
	cli.Param("baz", "foo")
	cli.Client.Middleware.Run("request", cli.Client.Context)
	st.Expect(t, cli.Client.Context.Request.URL.String(), "http://foo.com/baz/bar/foo")
}
...
func TestClientSetHeaders(t *testing.T) {
	...
	cli.Client.Middleware.Run("request", cli.Client.Context)
	st.Expect(t, cli.Client.Context.Request.Header.Get("foo"), "baz")
	st.Expect(t, cli.Client.Context.Request.Header.Get("baz"), "foo")
}
...
func TestClientAddCookie(t *testing.T) {
	...
	cli.Client.Middleware.Run("request", cli.Client.Context)
	st.Expect(t, cli.Client.Context.Request.Header.Get("Cookie"), "foo=bar")
}
