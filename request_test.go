...
func TestRequestMux(t *testing.T) {
	...
	req.Request.Mux().AddMatcher(func(ctx *context.Context) bool {
...
func TestRequestMethod(t *testing.T) {
	...
	st.Expect(t, req.Request.Context.Request.Method, "POST")
}
...
func TestRequestURL(t *testing.T) {
	...
	req.URL(url)
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.URL.String(), url)
}
...
func TestRequestBaseURL(t *testing.T) {
	...
	req.BaseURL(url)
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.URL.String(), "http://foo.com")
}
...
func TestRequestPath(t *testing.T) {
	...
	req.Path(path)
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.URL.String(), "http://foo.com/foo/baz")
}
...
func TestRequestAddPath(t *testing.T) {
	...
	req.AddPath(path)
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.URL.String(), "http://foo.com/bar/baz/foo/baz")
}
...
func TestRequestPathParam(t *testing.T) {
	...
	req.Param("baz", "foo")
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.URL.String(), "http://foo.com/baz/bar/foo")
}
...
func TestRequestSetQuery(t *testing.T) {
	...
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.URL.RawQuery, "foo=bar")
}
...
func TestRequestAddQuery(t *testing.T) {
	...
	req.AddQuery("foo", "bar")
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.URL.RawQuery, "foo=bar&foo=bar")
}
...
func TestRequestSetHeader(t *testing.T) {
	...
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.Header.Get("foo"), "bar")
}
...
func TestRequestAddHeader(t *testing.T) {
	...
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.Header.Get("foo"), "baz")
}
...
func TestRequestSetHeaders(t *testing.T) {
	...
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.Header.Get("foo"), "baz")
	st.Expect(t, req.Request.Context.Request.Header.Get("baz"), "foo")
}
...
func TestRequestAddCookie(t *testing.T) {
	...
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.Header.Get("Cookie"), "foo=bar")
}
...
func TestRequestCookieJar(t *testing.T) {
	...
	req.CookieJar()
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Reject(t, req.Request.Context.Client.Jar, nil)
}
...
func TestRequestType(t *testing.T) {
	...
	req.Type("json")
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, req.Request.Context.Request.Header.Get("Content-Type"), "application/json")
}
...
func TestRequestBody(t *testing.T) {
	...
	req.Body(reader)
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, int(req.Request.Context.Request.ContentLength), 7)
	st.Expect(t, req.Request.Context.Request.Header.Get("Content-Type"), "")
	body, _ := ioutil.ReadAll(req.Request.Context.Request.Body)
...
func TestRequestJSON(t *testing.T) {
	...
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, int(req.Request.Context.Request.ContentLength), 14)
	st.Expect(t, req.Request.Context.Request.Header.Get("Content-Type"), "application/json")
	body, _ := ioutil.ReadAll(req.Request.Context.Request.Body)
...
func TestRequestXML(t *testing.T) {
	...
	req.XML(xml)
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, int(req.Request.Context.Request.ContentLength), 50)
	st.Expect(t, req.Request.Context.Request.Header.Get("Content-Type"), "application/xml")
	body, _ := ioutil.ReadAll(req.Request.Context.Request.Body)
...
func TestRequestForm(t *testing.T) {
	...
	req.Form(data)
	req.Request.Middleware.Run("request", req.Request.Context)
	st.Expect(t, strings.Contains(req.Request.Context.Request.Header.Get("Content-Type"), "multipart/form-data"), true)
	body, _ := ioutil.ReadAll(req.Request.Context.Request.Body)
...
func TestRequestClone(t *testing.T) {
	...
	req1.Request.Context.Set("foo", "bar")
	req2 := req1.Clone()
	st.Expect(t, req1 != req2, true)
	st.Expect(t, req2.Request.Context.GetString("foo"), req1.Request.Context.GetString("foo"))
	st.Expect(t, len(req2.Request.Middleware.GetStack()), 2)
}
